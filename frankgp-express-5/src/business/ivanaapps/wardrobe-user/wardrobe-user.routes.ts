...
import { WardrobeUserController } from "./wardrobe-user.controller";
import { asyncHandler } from "../../../utils/asyncHandler";
import { verifyToken } from "../../../middleware/auth.middleware";

const router = Router();
const controller = new WardrobeUserController();
...
router.get("/findByUsername/:username", asyncHandler(controller.findByUsername.bind(controller)));
